...
public class emp_signin_Controller {
    ...
    @FXML private JFXPasswordField emp_pass;
    ...
    public void handleSignInButton(ActionEvent actionEvent) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        // Login successful - go to welcome screen
            ...
            // send email
            String msg = "You have just signed in to our system. If this was not you, then please contact us at farhanahmadmalik08@gmail.com";
...
//            goToEmpEdit();
    ...
    public void gotToEmpMenu() throws IOException {
        System.out.println("Loading customer menu");

        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("emp_menu.fxml"));
        Parent root = loader.load();

        //Get controller of cust menu scene
        emp_menu_controller controller = loader.getController();

        //setting information
        controller.setWelcome(LoggedInUsers.getEmp().getName());
