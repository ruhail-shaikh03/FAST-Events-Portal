...
public class Main_Menu_Controller {
    ...
    public void handleAboutButton(ActionEvent actionEvent) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        openPopup("About Us", "\n" +
                "Fast Events Portal\n" +
                "The Fast Events Portal is an innovative platform developed by a dedicated team of students from the National University of Computer and Emerging Sciences. Created to address the need for better visibility and accessibility of university events at FAST University, our portal enhances student engagement by providing an easy-to-use interface for event browsing, registration, and management" +
                "\n" +
                "Our team is committed to continuously improving the platform, leveraging the latest technologies and methodologies to ensure a seamless experience. We aim to empower students and faculty alike by making campus events more accessible and engaging, fostering a vibrant university community.");
    }

    // open popup
    public void openPopup(String heading, String text) throws IOException, UnsupportedAudioFileException, LineUnavailableException {
        ...
        window.initModality(Modality.APPLICATION_MODAL); // Make the window modal
        window.setTitle("Popup"); // Set a title for the window
        window.setScene(new Scene(root));
        window.setWidth(400);  // Set the width of the window
        window.setHeight(400); // Set the height of the window
        window.setResizable(false); // Optional: Make the window not resizable

        window.show();
        // Assuming audioPlayer.play() is a method to play a sound
        audioPlayer.play();
    }
    public void handlePrivacyButton(ActionEvent actionEvent) throws UnsupportedAudioFileException, IOException, LineUnavailableException {
        openPopup("Privacy Policy", "Privacy Policy\n" +
                ...
                "\n" +
                "By email: farhanahmadmalik08@gmail.com");
    }
}
