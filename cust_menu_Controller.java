...
public class cust_menu_Controller
{
    ...
    public void handlenotifyButton(ActionEvent actionEvent) throws UnsupportedAudioFileException, LineUnavailableException, IOException {
        System.out.println("Notification button pressed");

        Customer cust = new Customer();
        String message=cust.getCustomerMessageByID(LoggedInUsers.getCust_id());
    ...
    public void goToBookEvent() throws IOException {
        ...
        //Load next
        FXMLLoader loader = new FXMLLoader(getClass().getResource("cust_register_event.fxml"));
        Parent root = loader.load();

        //Get controller of event scene
        cust_reg_event_controller controller = loader.getController();
