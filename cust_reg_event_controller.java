...
public class cust_reg_event_controller implements Initializable {
...
//    }
    ...
    public void handleViewButton(ActionEvent actionEvent) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        RegEvent(selectedEventID.getText());
    }
...
//    }
    ...
    public void RegEvent(String eventID) throws IOException, LineUnavailableException, UnsupportedAudioFileException {
        ...
        if (controller.setEventDetails(eventID, 0)) {
            ...
            openPopup("Congratulations", "You have registered for the event");
